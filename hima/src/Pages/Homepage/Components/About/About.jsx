      ...
      <div className="about-1 gap-7 flex flex-col lg:flex-row px-4 sm:px-8 lg:px-14 lg:gap-20">
        ...
        <div className="div-1 flex flex-col justify-between 2xl:w-1/2 w-full px-2">
          <div className="flex flex-col gap-2">
            <h1 className="about-head mb-10 text-black text-[30px] leading-7 flex flex-col gap-1 sm:flex-row sm:gap-2 lg:flex-col 2xl:text-[37px] 2xl:leading-8">
            ...
            <div className="flex gap-4">
              <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
                ...
                <div className="banner-in top-2 flex flex-col items-center text-white 2xl:top-4">
                  <span className="text-[14.5px] leading-3 sm:text-[17px] 2xl:text-[19px]">
                    ONE OF
                  </span>
                  <span className="text-[13px] leading-4 sm:text-[15px] sm:leading-6 2xl:text-[17px] 2xl:leading-7">
                    INDIA'S
                  </span>
              ...
              <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
                ...
                <div className="banner-in1 flex flex-col items-center text-white top-2 2xl:top-4">
                  ...
                  <span className="text-[24px] leading-6 sm:text-[28px] sm:leading-7 2xl:text-[33px] 2xl:leading-8">
                    1 NRC
                  </span>
                  <span className="leading-3 text-[9.4px] sm:text-[10.7px] sm:leading-4 2xl:text-[12.8px] 2xl:leading-6">
                    LAB-CERTIFIED
                  </span>
                  <span className="text-[31px] leading-7 sm:text-[36px] 2xl:text-[43px] 2xl:leading-9">
                    panel
                  </span>
                </div>
              </div>
              <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
                ...
                <div className="banner-in2 flex flex-col items-center text-white top-2 2xl:top-4">
                  ...
                  <span className="text-[13.5px] leading-3 sm:text-[16px] sm:leading-4 2xl:text-[18px]">
                    ACOUSTIC
                  </span>
                  <span className="text-[10.1px] leading-3 sm:text-[12px] sm:leading-4 2xl:text-[13.5px] 2xl:leading-5">
                    PERFORMANCE
                  </span>
                  <span className="text-black text-[19.5px] leading-4 sm:text-[23px] 2xl:text-[25.6px] 2xl:leading-5">
                    with our
                  </span>
                  <span className="text-[20px] leading-4 sm:text-[23.5px] sm:leading-7 2xl:text-[26.2px]">
                    SILENT
                  </span>
                  <span className="leading-3 text-[7.5px] sm:text-[8.8px] 2xl:text-[10px] 2xl:leading-4">
                    ACOUSTIC DRYWALL
                  </span>
                  <span className="leading-4 text-[17.5px] sm:text-[20.6px] sm:leading-5 2xl:text-[23px] 2xl:leading-6">
                    Partition
                  </span>
                  <span className="leading-3 text-black text-[15.3px] sm:text-[18px] 2xl:text-[20.2px] 2xl:leading-4">
                    range with
                  </span>
                  <span className="leading-3 text-[12px] sm:text-[14.35px] sm:leading-6 2xl:text-[16px] 2xl:leading-6">
                    UPTO 65 STC
                  </span>
                </div>
              </div>
              <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
                ...
                <div className="banner-in3 flex flex-col items-center text-white top-2 2xl:top-4">
                  ...
                  <span className="leading-3 text-[9px] sm:text-[11px] sm:leading-4 2xl:text-[13px]">
                    SUSTAINABLE &
                  </span>
                  <span className="leading-3 text-[7.8px] sm:text-[9.5px] sm:leading-4 2xl:text-[11.5px]">
                    GREEN CERTIFIED
                  </span>
                  <span className="leading-3 text-[8.9px] sm:text-[10.8px] sm:leading-4 2xl:text-[13px] 2xl:leading-5">
                    CEMENT FIBRES
                  </span>
                  ...
                  <span className="leading-4 text-[17px] sm:text-[19.4px] sm:leading-5 2xl:text-[24px] 2xl:leading-6">
                    APHONY
                  </span>
                  <span className="leading-4 text-[14.8px] sm:text-[17px] sm:leading-5 2xl:text-[20.8px] 2xl:leading-6">
                    FIBRETTE
                  </span>
                </div>
              </div>
      ...
      <div className="about-2 flex flex-col px-2 mt-2 gap-10 sm:px-8 lg:px-14 lg:gap-20 lg:flex-row">
        <div className="flex w-full items-center lg:w-1/2">
          ...
          <span className="flex flex-col text-[#818181] text-[14px] font-[Arial] sm:text-[22px] md:text-[24px] lg:text-[18px] xl:text-[22px]">
            ...
            <Link
              className="text-[14px] font-semibold text-[#E23424] sm:text-[16px]"
              to=""
            >
              Read More...
            </Link>
