    ...
    <div className="about">
      <div className="about-1 gap-7 flex flex-col lg:flex-row px-4 sm:px-8 lg:px-14 lg:gap-20">
        <div className="div-1 flex flex-col 2xl:w-1/2 w-full px-2">
          <h1 className="about-head text-[30px] leading-7 flex flex-col sm:flex-row sm:gap-2 lg:flex-col md:text-[30px] md:leading-8 md:m-0 lg:leading-6">
            acoustic
            <span> meet's design!!</span>
          </h1>
          <span className="about-desc text-xs flex flex-col gap-2 leading-5 text-justify sm:text-[14px] sm:leading-6 lg:text-[12px] xl:text-[16px]">
        ...
        <div className="div-1 flex flex-col 2xl:w-1/2 w-full px-2">
          <h1 className="about-head mb-10 text-[30px] leading-7 flex flex-col gap-1 sm:flex-row sm:gap-2 lg:flex-col">
            performance
          ...
          <div className="flex justify-between gap-1">
            ...
            <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
              ...
              <div className="banner-in2 flex flex-col items-center text-white top-2">
                ...
                <span className="text-[13.5px] leading-3 sm:text-[16px] sm:leading-4">ACOUSTIC</span>
                <span className="text-[10.1px] leading-3 sm:text-[12px] sm:leading-4">PERFORMANCE</span>
                <span className="text-black text-[19.5px] leading-4 sm:text-[23px]">
                  with our
                </span>
                <span className="text-[20px] leading-4 sm:text-[23.5px] sm:leading-7">SILENT</span>
                <span className="leading-3 text-[7.5px] sm:text-[8.8px]">ACOUSTIC DRYWALL</span>
                <span className="leading-4 text-[17.5px] sm:text-[20.6px] sm:leading-5">Partition</span>
                <span className="leading-3 text-black text-[15.3px] sm:text-[18px]">
                  range with
                </span>
                <span className="leading-3 text-[12px] sm:text-[14.35px] sm:leading-6">UPTO 65 STC</span>
              </div>
            </div>
            <div className="banner flex flex-col justify-centre 2xl:w-auto justify-center items-center w-36">
              <img
              ...
              <div className="banner-in3 flex flex-col items-center text-white top-2">
                ...
                <span className="leading-3 text-[9px] sm:text-[11px] sm:leading-4">SUSTAINABLE &</span>
                <span className="leading-3 text-[7.8px] sm:text-[9.5px] sm:leading-4">GREEN CERTIFIED</span>
                <span className="leading-3 text-[8.9px] sm:text-[10.8px] sm:leading-4">CEMENT FIBRES</span>
                ...
                <span className="leading-4 text-[17px] sm:text-[19.4px] sm:leading-5">APHONY</span>
                <span className="leading-4 text-[14.8px] sm:text-[17px] sm:leading-5">FIBRETTE</span>
              </div>
            </div>
          </div>
        </div>
