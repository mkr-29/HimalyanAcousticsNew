  ...
  return (
    <div>
      ...
      <div className="history flex flex-col lg:flex-row px-4 2xl:px-24 py-8 my-8 mt-24 gap-20">
        ...
        <div className="years-ha grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8 2xl:gap-0 2xl:ml-44">
          <div className="flex gap-4 justify-center items-center">
            ...
            <div>
              <h3 className="text-2xl 2xl:text-3xl font-medium">Himalyan Acoustics</h3>
              <p className="2xl:w-[90%]">This is a sample text insert your desired text here.</p>
            </div>
          </div>
          <div className="flex gap-4 justify-center items-center">
            ...
            <div>
              <h3 className="text-2xl font-medium 2xl:text-3xl">Himalyan Acoustics</h3>
              <p className="2xl:w-[90%]">This is a sample text insert your desired text here.</p>
            </div>
          </div>
          <div className="flex gap-4 justify-center items-center">
      ...
      <div className="who-wr flex flex-col gap-4 px-4 md:px-24 py-8 ">
        ...
        <p className="ceo-quote text-right font-semibold text-sm 2xl:text-left 2xl:ml-[25%] 2xl:text-2xl">
          With technical excellence and cutting-edge solutions, our team<br/>with a
          commitment to build future-ready spaces.
        </p>
        <p className="quote-by-ceo text-right 2xl:text-2xl text-xl font-bold 2xl:mr-[25%]">By Mohit Munshi - CEO</p>
      </div>
